            ...
            <div className="prose prose-invert mt-10 max-w-none space-y-8 text-slate-300">
              <section>
                ...
                <p>
                  ...
                  Nervia, including the website, application, browser extension, and related
                  services (the &quot;Service&quot;) operated by Nervia. By accessing or using the
                  Service - including signing in via Google, GitHub, or Magic Link - you agree to be
                  bound by these Terms and our Privacy Policy. If you do not agree, you may not use
                  the Service.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-white">2. Description of the Service</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-white">3. Account and Eligibility</h2>
                <p>
                  You must be at least 13 years old (or the age of consent in your jurisdiction)
                  to use the Service. You are responsible for maintaining the confidentiality of
                  your account credentials and for all activity under your account. You must
                  provide accurate information when signing up and notify us of any unauthorized
                  use.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>Infringe any third-party rights (intellectual property, privacy, or otherwise)</li>
              ...
              <section>
                <h2 className="text-xl font-semibold text-white">5. Your Content and Licenses</h2>
                <p>
                  ...
                  content solely to operate and improve the Service (e.g., to run the 3D graph and
                  AI features). We do not claim ownership of your content.
                </p>
                <p>
                  You are responsible for ensuring you have the rights to upload and use any
                  content you provide. When you share content with others (e.g., publishing a
                  cluster), you may grant them access as permitted by the sharing options you
                  choose.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Nervia and its branding, design, software, and documentation are owned by us or
                  our licensors. You may not copy, modify, or create derivative works of our
                  Service or branding except as necessary to use the Service in accordance with
                  these Terms.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR SECURE. AI-GENERATED OUTPUTS (E.G.,
                  NEURAL CORE) ARE FOR ASSISTANCE ONLY AND DO NOT CONSTITUTE LEGAL, MEDICAL, OR
                  PROFESSIONAL ADVICE.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  SERVICE. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE
                  TWELVE MONTHS PRECEDING THE CLAIM (OR ONE HUNDRED U.S. DOLLARS IF GREATER).
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  attorneys&apos; fees) arising from your use of the Service, your content, or
                  your violation of these Terms.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-white">11. Changes to the Terms</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-white">12. Governing Law and Disputes</h2>
                <p>
                  These Terms are governed by the laws of the jurisdiction in which Nervia
                  operates, without regard to conflict of law principles. Any disputes shall be
                  resolved in the courts of that jurisdiction, except where prohibited.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  For questions about these Terms, please contact us through the contact
                  information provided on the Nervia website or application.
                </p>
              </section>
            </div>
