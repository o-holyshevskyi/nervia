...
export function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-50 w-full border-b border-white/10 bg-white/[0.03] backdrop-blur-xl transition-[transform] duration-350 ease-[cubic-bezier(0.4,0,0.2,1)]"
