...
interface NeuralBackgroundProps {
  /** Unique id for the clip path when multiple instances exist (e.g. header icon). */
  clipPathId?: string;
}

export function NeuralBackground({ clipPathId = "neural-brain-clip-landing" }: NeuralBackgroundProps) {
