    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-neutral-900/80 backdrop-blur-2xl border border-purple-500/30 rounded-2xl shadow-[0_0_40px_rgba(168,85,247,0.2)] overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
                ...
                <button
                  ...
                  className="hover:cursor-pointer px-3 py-1.5 rounded-lg bg-purple-600 hover:bg-purple-500 disabled:opacity-50 disabled:hover:cursor-not-allowed text-white text-sm font-medium shrink-0"
                >
                  Search
                </button>
                <span className="hidden sm:inline-flex items-center gap-0.5 text-[10px] text-neutral-500 font-mono">
              ...
              <div className="max-h-[50vh] overflow-y-auto no-scrollbar p-2">
                ...
                {!isLoading && showTextResults && textFilteredNodes.length > 0 && (
                  <>
                    <p className="px-2 py-1 text-[10px] font-medium text-neutral-500 uppercase tracking-wider">
                      By text
                    </p>
                  ...
                  <>
                    ...
                    return (
                      <button
                        ...
                        className="hover:cursor-pointer w-full flex flex-col items-start px-4 py-3 text-left rounded-xl hover:bg-white/5 transition-colors group"
                      >
                        ...
                        {r.reason && (
                          <p className="text-xs text-neutral-400 mt-1 line-clamp-2 ml-11">{r.reason}</p>
                        )}
                      </button>
                    );
                    })}
