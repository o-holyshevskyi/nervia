  ...
  return (
    <main className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-lg bg-neutral-900/60 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl relative z-10 overflow-hidden"
      >
            ...
            >
              ...
              <div className="space-y-4 mb-10">
                <div className="flex items-center gap-2">
                  <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-500/20 border border-purple-500/30 text-purple-400 text-sm font-bold">
                    1
                  </span>
                  <span className="text-sm font-semibold text-white">Download the extension</span>
                </div>
                <a
                  href="/api/extension/download"
                  download="synapse-clipper.zip"
                  className="hover:cursor-pointer flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-purple-500/20 border border-purple-500/40 text-purple-300 hover:bg-purple-500/30 hover:text-white font-medium transition-all shadow-[0_0_20px_rgba(168,85,247,0.15)]"
                >
                  <Download size={20} />
                  Download synapse-clipper.zip
                </a>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-white">Load it in Chrome</span>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-white mb-0.5">Enable Developer mode</p>
                      <p className="text-xs text-neutral-500">
                        Open <code className="bg-black/30 px-1.5 py-0.5 rounded text-neutral-400">chrome://extensions</code> and turn on Developer mode (top-right).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-white mb-0.5">Load unpacked</p>
                      <p className="text-xs text-neutral-500">
              ...
              <Link
                href="/"
                className="hover:cursor-pointer mt-8 flex items-center justify-center gap-2 text-sm text-neutral-400 hover:text-white transition-colors"
              >
                <ArrowLeft size={16} />
                Back to dashboard
              </Link>
